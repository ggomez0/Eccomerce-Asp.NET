    ...
    <div class="container">
                                          ...
                                          <li class="nav-item" role="presentation">
                                            ...
                                            <button class="nav-link" id="pills-fact-tab" data-bs-toggle="pill" data-bs-target="#pills-fact" type="button" role="tab" aria-controls="pills-fact" aria-selected="false">Factura</button>
                                               ...
                                               <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-pago-tab" data-bs-toggle="pill" data-bs-target="#pills-pago" type="button" role="tab" aria-controls="pills-pago" aria-selected="false">Pago</button>
                                          </li> 
            ...
            <asp:TemplateField HeaderText="Cant.">
                <ItemTemplate>
                 ...
                 <h3>Pago de Facturas</h3>
                                                ...
                                                <asp:Button runat="server" ID="btnabrirpagofact" CssClass="btn btn-success rounded-3" Text="Realizar Pago" />
                                    <!-- ModalPopupExtender -->
                                    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
                                        PopupControlID="Panel1059" TargetControlID="btnabrirpagofact" CancelControlID="btncerrarpagofact"
                                        BackgroundCssClass="modalBackground">
                                    </cc1:ModalPopupExtender>
                                    <asp:Panel ID="Panel1059" runat="server" CssClass="modalPopup" align="center"
                                        ...
                                        <asp:Button ID="btncerrarpagofact" CssClass="btn btn-danger rounded-3" runat="server" Text="Cerrar"/>
