        ...
        protected void GenerateInvoicePDF(object sender, EventArgs e)
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    sb.Append("<tr><td><b>N° Factura: </b>");
                    sb.Append(orderNo);
                    sb.Append("</td><td align = 'right'><b>Fecha: </b>");
                    sb.Append(DateTime.Now);
                    sb.Append(" </td></tr>");
                    sb.Append("<tr><td colspan = '2'><b>Proveedor: </b>");
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=Factura-" + orderNo + ".pdf");
